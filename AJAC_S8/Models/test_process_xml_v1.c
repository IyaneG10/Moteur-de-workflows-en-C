...
// soit 2 arguments:  respectivement login et password 


{
    //Process *myProcess;
    //myProcess = (struct Processus*)malloc(sizeof(struct Processus));
	...
	ListActivities *listdebut = NULL;
    
    	/* Instanciation des activites pour le moment sans passer par le parsing du fichier xml*/
	ajouterSurListeActivites(&listdebut, "A1","Demande","Remplir la demande de stage","tmv"/*,NULL,NULL*/,"NOT STARTED");
	ajouterSurListeActivites(&listdebut, "A2","Etude_demande","Etude de la demande","rex"/*,NULL,NULL*/, "NOT STARTED" );  
	ajouterSurListeActivites(&listdebut, "A3","Refus","Demande de stage refusee","tmv"/*,NULL,NULL*/, "NOT STARTED" );
	ajouterSurListeActivites(&listdebut, "A4","Redaction","Redaction de la convention de stage","nd"/*,NULL,NULL*/, "NOT STARTED" );
	ajouterSurListeActivites(&listdebut, "A5","Signature","Signature de la convention de stage par l'etudiant","tmv"/*,NULL,NULL*/, "NOT STARTED" );
	ajouterSurListeActivites(&listdebut, "A6","Signature","Signature de la convention de stage par l'entreprise","HAL"/*,NULL,NULL*/, "NOT STARTED" );
	ajouterSurListeActivites(&listdebut, "A7","Signature","Signature de la convention de stage par l'ecole","nd"/*,NULL,NULL*/, "NOT STARTED" );


	afficherActivites(listdebut,login,id_activity);
